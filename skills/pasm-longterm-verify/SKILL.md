...
description: >-
  PASM long-term verification agents - repeatable, dependency-free agents that answer "is the
  cognitive engine still healthy after long runs?". Use when checking memory retention, emotion drift,
  behavioural rigidity, long-run degradation, cross-repo parity, or when adding structural +
  behavioural health checks to CI.
version: 0.5.0
license: MIT
author: arronzheng
